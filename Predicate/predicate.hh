...
namespace bats {
  ...
  public:
    ...
    */
     ...
     *  Pushes a leaf type predicate with value val.
     */
    void pushLeaf(double val, unsigned precision = 5)
    {
      std::ostringstream s;
     ...
     *
     *  Node: should make ordered predicate list type!
     */
     ...
     */
    void pushLeafs(Eigen::Vector3d const& vec)
    {
      pushLeaf(vec.x());
      pushLeaf(vec.y());
      pushLeaf(vec.z());
    ...
    /**
     *  @returns the long int value of argument name.
     */
    long getLong() const { return std::atol(d_value.c_str()); }
