...
{
  Vector3d origin = (matrix * Vector4d(0,0,0,0)).start<3>();
  Vector3d unitX  = (matrix * Vector4d(1,0,0,0)).start<3>() * axisLength;
  Vector3d unitY  = (matrix * Vector4d(0,1,0,0)).start<3>() * axisLength;
  Vector3d unitZ  = (matrix * Vector4d(0,0,1,0)).start<3>() * axisLength;
